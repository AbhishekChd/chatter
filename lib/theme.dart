...
abstract class AppTheme {
  ...
  static ThemeData light() => ThemeData(
      ...
      appBarTheme: const AppBarTheme(titleTextStyle: TextStyle(color: AppColors.textDark)));
  ...
  static ThemeData dark() => ThemeData(
      ...
      appBarTheme: const AppBarTheme(titleTextStyle: TextStyle(color: AppColors.textLight)));
}
